                ...
                if theme ~= "Rainbow" then
                    ...
                    elseif #ThemeService.Themes[theme] == 3 then
                        ...
                        local colorseq = ColorSequence.new({
                            ...
                            ColorSequenceKeypoint.new(0.25, theme2[2]),
                            ColorSequenceKeypoint.new(0.5, theme2[3]),
                            ColorSequenceKeypoint.new(0.75, theme2[2]),
                            ColorSequenceKeypoint.new(1, theme2[1])
                        })
